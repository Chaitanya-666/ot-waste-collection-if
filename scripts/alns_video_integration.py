...
#
# This file provides an example of how to integrate video tracking into the
# ALNS algorithm. It shows how to modify the main optimization loop to
# record the state of the solution at different iterations, which can then
# be used to create a video of the optimization process.
#!/usr/bin/env python3
"""
