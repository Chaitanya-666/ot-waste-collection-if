...
#
# This file is responsible for creating animated videos of the ALNS
# optimization process. It uses matplotlib to generate frames of the
# solution at different iterations and then combines them into a video
# file (MP4 or GIF).
#!/usr/bin/env python3
"""
